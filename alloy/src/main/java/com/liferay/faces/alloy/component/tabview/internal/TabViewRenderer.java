...
/**
 * This class is a JSF {@link jakarta.faces.render.Renderer} for the alloy:tabView component.
 *
 * @author  Neil Griffin
			...
			if (clientBehaviorsForEvent != null) {
				...
				for (ClientBehavior clientBehavior : clientBehaviorsForEvent) {
					...
					if (TabSelectEvent.TAB_SELECT.equals(eventName)) {
						...
						//J-
						// function(event) {
						//	jsf.ajax.request(this, event, {'jakarta.faces.behavior.event': 'tabSelect'})
						// };
						//J+
