 ...
 */
public class ResourceDependencyVerifierFactoryAlloyImpl extends ResourceDependencyVerifierFactory {
	...
	public ResourceDependencyVerifier getResourceDependencyVerifier() {
		...
		ResourceDependencyVerifier resourceDependencyVerifier =
			wrappedResourceDependencyVerifierFactory.getResourceDependencyVerifier();

		return new ResourceDependencyVerifierAlloyImpl(resourceDependencyVerifier);
	}
