...
/**
 * This class is a {@link ResponseWriter} that will suppress writing of the "value" attribute (the rendered text of the
 * hyperlink) if the {@link CommandLink} has children, so that the rendered children will determine the text of the
 * hyperlink.
 *
 * @author  Neil Griffin
 */
