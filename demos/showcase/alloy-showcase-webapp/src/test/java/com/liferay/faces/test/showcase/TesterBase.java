...
public class TesterBase {
	...
	private static String context = System.getProperty("integrationContext",
			"/alloy-showcase-webapp-3.0.0-SNAPSHOT/web/guest/showcase/-/component/alloy/");
	private static String host = System.getProperty("integrationHost", "localhost");
	private static String port = System.getProperty("integrationPort", "8080");
	...
	private static String signInContext = System.getProperty("integrationSignInContext", "");
	/* package-private */ static String container = System.getProperty("integrationContainer", "tomcat");
